...
{
    public class FeelingDialog : ComponentDialog
    {
        private readonly ConversationRecognizer _luisRecognizer;
        protected readonly ILogger Logger;
        public FeelingDialog(ConversationRecognizer luisRecognizer, ILogger<TopLevelDialog> logger)
           : base(nameof(FeelingDialog))
        {
